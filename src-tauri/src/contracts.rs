...
pub(crate) const PINNED_INSTALLER_FILES: [PinnedInstallerFile; 57] = [
    ...
    PinnedInstallerFile {
        ...
        sha256: "534e3eeea29c2e66c8545cfc1abcfab2fb61515cadd3e4ffb08018bee5adda9d",
        bytes: 12_361,
        executable: true,
    },
    PinnedInstallerFile {
    ...
    PinnedInstallerFile {
        path: "lib/recovery_policy.py",
        sha256: "605ef7fe98216db99bfc4bca1d39f105298ef5ceee411a9935302629b8e3bce6",
        bytes: 4_522,
        executable: true,
    },
    PinnedInstallerFile {
        path: "lib/recovery_fallback_state.py",
        sha256: "591076bea90513928e24c6e9afa8fb3fbb2e012a1f649ac8794cdd53adead218",
        bytes: 7_149,
        executable: true,
    },
    PinnedInstallerFile {
        path: "lib/validate_github_meta.py",
        sha256: "3a26fc6c8bdf66d785f7a78b0c0aecb1aaad979f1aafc2ed9c1780f334b2dab1",
        bytes: 1_300,
        executable: true,
    },
    PinnedInstallerFile {
...
pub(crate) struct NvidiaInstallInputs {
    ...
    pub(crate) installer_commit: String,
    pub(crate) installer_files: Vec<NvidiaInstallerBundleFile>,
...
pub(crate) struct NvidiaInstallHandoffResult {
    ...
    pub(crate) support_commit: String,
    pub(crate) support_files: Vec<NvidiaInstallerBundleFile>,
    pub(crate) steamos_version: String,
    pub(crate) kernel_version: String,
    pub(crate) nvidia_version: String,
    pub(crate) trust: String,
