...
const coreContractCommit = "30e2550895245729314a6ab91cc1753d5fbc7c15";
...
assert.match(
  checks,
  /ref: 30e2550895245729314a6ab91cc1753d5fbc7c15\n          path: opemos-core-contracts\n          fetch-depth: 183\n          persist-credentials: false/,
);
...
assert.match(linuxGuide, /Google Chrome \*\*152\.0\.7977\.82\*\*/);
assert.match(linuxGuide, /node scripts\/check_forced_colors_browser\.mjs/);
assert.match(linuxGuide, /no screenshot, desktop capture,/);
