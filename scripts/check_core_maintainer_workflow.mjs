...
const actual = JSON.parse(execFileSync("python3", [path.join(root, "lib/maintainer_release_workflow.py"), "--steamos", "3.8.16", "--kernel", "6.16.12-valve24.5-1-neptune-616-gb2f7cfe85e45", "--nvidia", "575.64.05", "--architecture", "x86_64"], { encoding: "utf8" }));
