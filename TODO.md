...
* [ ] Resolve the real recovery image's pacman database/root semantics before retrying mutation; validation must reject an unreadable `<root>/var/lib/pacman` before entering the mutating phase.
